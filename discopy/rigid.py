...
class Ty(monoidal.Ty, Ob, Sequence[Ob]):
    ...
    """
    @staticmethod
    def upgrade(ty: 'Ty') -> 'Ty':  # type: ignore[override]
...
class PRO(monoidal.PRO, Ty):
    ...
    """
    @staticmethod
    def upgrade(ty : Ty) -> 'PRO':  # type: ignore[override]
...
class Diagram(monoidal.Diagram):
    ...
    """
    @staticmethod
    def upgrade(diagram: monoidal.Diagram) -> 'Diagram':  # type: ignore[override]
        """
        ...
        return Diagram(Ty(*diagram.dom), Ty(*diagram.cod),
                       ...
                       layers=cast(Composable[Ty], diagram.layers))
